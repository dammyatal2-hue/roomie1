import svgPaths from "./svg-qdzt9cqgm7";
...
function Caption() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-[327px]" data-name="Caption">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[26px] relative shrink-0 text-[#1f2a37] text-[20px] text-center">Register Account</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[#9da4ae] text-[14px] w-[min-content]">
        <p className="css-4hzbpn mb-0">{`Sign in with your email and password `}</p>
        <p className="css-4hzbpn">or social media to continue</p>
      </div>
    </div>
  );
}
...
function Form() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-[52px] items-center px-[16px] py-[8px] relative rounded-[12px] shrink-0 w-[327px]" data-name="Form">
      ...
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-h-px min-w-px not-italic relative text-[#1f2a37] text-[14px]">dammy@gmail.com</p>
    </div>
  );
}
...
function InputForm() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Input Form">
      <p className="css-4hzbpn font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#1f2a37] text-[14px] w-[327px]">Email</p>
      <Form />
    </div>
  );
}
...
function Form1() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-[52px] items-center px-[16px] py-[8px] relative rounded-[12px] shrink-0 w-[327px]" data-name="Form">
      ...
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-h-px min-w-px not-italic relative text-[#9da4ae] text-[14px]">Username</p>
    </div>
  );
}
...
function InputForm1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Input Form">
      <p className="css-4hzbpn font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#1f2a37] text-[14px] w-[327px]">Username</p>
      <Form1 />
    </div>
  );
}
...
function Form2() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-[52px] items-center px-[16px] py-[8px] relative rounded-[12px] shrink-0 w-[327px]" data-name="Form">
      <div aria-hidden="true" className="absolute border border-[#d2d6db] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-h-px min-w-px not-italic relative text-[#9da4ae] text-[14px]">Password</p>
      <IconlyLightHide />
    </div>
  );
}
...
function InputForm2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Input Form">
      <p className="css-4hzbpn font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#1f2a37] text-[14px] w-[327px]">Password</p>
      <Form2 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative">
      <Checkbox />
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px not-italic relative text-[#1f2a37] text-[0px] text-[14px]">
        <span className="leading-[18px]">{`Agree with `}</span>
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px]">{`terms `}</span>
        <span className="leading-[18px]">and</span>
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px]">{` privacy`}</span>
      </p>
    </div>
  );
}
...
function ForgetPassword() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Forget Password">
      <Frame1 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#fe456a] content-stretch flex gap-[12px] h-[52px] items-center justify-center px-[24px] py-[8px] relative rounded-[8px] shadow-[0px_8px_8px_0px_rgba(127,86,217,0.03),0px_20px_24px_0px_rgba(127,86,217,0.08)] shrink-0 w-[327px]" data-name="Button">
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[18px] text-white">Sign up</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[46px]" data-name="Google">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46 46">
        <g id="Google">
          ...
          <g clipPath="url(#clip0_105_2062)" id="google (1) 1">
...
function Button() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0" data-name="Button">
      <Button1 />
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#1f2a37] text-[14px]">{`Or `}</p>
      <SocialMedia />
    </div>
  );
}
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center justify-center left-[24px] top-[116px]" data-name="Content">
      ...
      <FormInput />
      <Button />
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#1f2a37] text-[0px] text-[14px]">
        <span className="leading-[18px]">{`Already have an account ? `}</span>
        <span className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] text-[#fe456a]">Sign in</span>
      </p>
    </div>
  );
}
...
export default function SignUp() {
  return (
    <div className="bg-[#fcfcfd] relative size-full" data-name="Sign Up">
