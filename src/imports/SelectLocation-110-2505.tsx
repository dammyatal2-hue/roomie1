import svgPaths from "./svg-m3705rgro1";
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] top-[610px]" data-name="Button">
      <div className="bg-[#fe456a] content-stretch flex gap-[12px] h-[52px] items-center justify-center px-[24px] py-[8px] relative rounded-[8px] shadow-[0px_8px_8px_0px_rgba(127,86,217,0.03),0px_20px_24px_0px_rgba(127,86,217,0.08)] shrink-0 w-[327px]" data-name="Button">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">Use current location</p>
      </div>
      <div className="bg-white content-stretch flex gap-[12px] h-[52px] items-center justify-center px-[24px] py-[8px] relative rounded-[8px] shrink-0 w-[327px]" data-name="Button">
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#fe456a] text-[18px] whitespace-nowrap">Select it manually</p>
      </div>
    </div>
  );
}
...
function Group() {
  return (
    <div className="col-1 h-[145.971px] ml-[104.76px] mt-[68.96px] relative row-1 w-[192.786px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 192.786 145.971">
        <g id="Group">
...
function Group4() {
  return (
    <div className="col-1 h-[46.526px] ml-[9px] mt-0 relative row-1 w-[12.854px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.8537 46.5259">
        <g id="Group">
...
function Group5() {
  return (
    <div className="col-1 h-[32.109px] ml-[20.6px] mt-[13.49px] relative row-1 w-[16.672px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6717 32.1094">
        <g id="Group">
...
function Group6() {
  return (
    <div className="col-1 h-[35.299px] ml-0 mt-[10.5px] relative row-1 w-[17.142px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.1417 35.2995">
        <g id="Group">
...
function Group7() {
  return (
    <div className="col-1 h-[15.721px] ml-[23.02px] mt-[29.54px] relative row-1 w-[15.473px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.4729 15.7206">
        <g id="Group">
...
function Group1() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[228.45px] mt-[153.07px] place-items-start relative row-1" data-name="Group">
      <Group3 />
      <div className="col-1 h-[18.924px] ml-[9.9px] mt-[42.9px] relative row-1 w-[22.389px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.3891 18.924">
      ...
      <div className="col-1 h-[2.769px] ml-[9.9px] mt-[42.9px] relative row-1 w-[22.389px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.3891 2.76935">
      ...
      <div className="col-1 h-[18.924px] ml-[21.62px] mt-[42.9px] relative row-1 w-[10.657px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6572 18.924">
...
function Group8() {
  return (
    <div className="col-1 h-[103.066px] ml-[5.63px] mt-0 relative row-1 w-[276.298px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 276.298 103.066">
        <g id="Group">
...
function Group10() {
  return (
    <div className="col-1 h-[164.705px] ml-0 mt-0 relative row-1 w-[157.332px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 157.332 164.705">
        <g id="Group">
...
function Group11() {
  return (
    <div className="col-1 h-[156.854px] ml-[3.75px] mt-[3.92px] relative row-1 w-[149.823px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 149.823 156.854">
        <g id="Group">
...
function Group9() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[58.9px] mt-[50.77px] place-items-start relative row-1" data-name="Group">
      <Group10 />
      <Group11 />
    </div>
  );
...
function Group13() {
  return (
    <div className="col-1 h-[19.66px] ml-[15.82px] mt-0 relative row-1 w-[61.03px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 61.0296 19.6599">
        <g id="Group">
...
function Group14() {
  return (
    <div className="col-1 h-[19.66px] ml-0 mt-[17.3px] relative row-1 w-[61.03px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 61.0296 19.6599">
        <g id="Group">
...
function Group12() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[19.46px] mt-[126.07px] place-items-start relative row-1" data-name="Group">
      <Group13 />
      <Group14 />
    </div>
  );
...
function Group16() {
  return (
    <div className="col-1 h-[84.698px] ml-0 mt-0 relative row-1 w-[89.05px]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 89.0501 84.6984">
        <g id="Group">
          <g id="Group_2">
...
function Home() {
  return (
    <div className="absolute inset-[8.33%_10.42%]" data-name="Home">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.7747 23.9734">
        <g id="Home">
          <path d={svgPaths.p9a85100} fill="var(--fill-0, #FE456A)" id="Home_2" />
        </g>
      </svg>
    </div>
  );
...
function Group15() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[86.31px] mt-[108.3px] place-items-start relative row-1">
      <Group16 />
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[145.971px] ml-0 mt-[68.97px] relative row-1 w-[297.545px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 297.545 145.971">
      ...
      <div className="col-1 h-[22.997px] ml-[156.53px] mt-[69.38px] relative row-1 w-[14.854px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.8543 22.9972">
      ...
      <div className="col-1 h-[22.997px] ml-[183.37px] mt-[134.76px] relative row-1 w-[14.864px]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.8642 22.9972">
...
function Caption() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center not-italic relative shrink-0 text-center w-[289px]" data-name="Caption">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[26px] relative shrink-0 text-[#1f2a37] text-[20px] whitespace-nowrap">Hi, Nice to meet you !</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[#9da4ae] text-[14px] w-[min-content]">
        <p className="mb-0">Choose your location to find property</p>
        <p>around you</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-[#fcfcfd] relative size-full" data-name="Select location">
      ...
      <div className="absolute content-stretch flex gap-[4px] h-[32px] items-center justify-center left-[calc(75%+12.75px)] px-[16px] py-[8px] rounded-[24px] top-[60px]" data-name="Button">
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#4d5761] text-[12px] whitespace-nowrap">Skip</p>
      </div>
      <Button />
      <Content />
    </div>
